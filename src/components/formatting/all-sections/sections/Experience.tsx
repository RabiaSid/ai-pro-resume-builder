...
const Experience = ({ sectionData, handleAddSec }: { sectionData: any, handleAddSec: any }) => {
  ...
  return (
    <div className="group relative w-full border border-[#CECECE] h-56 bg-white rounded-[10px] p-5 flex flex-row hover:bg-primary2 overflow-hidden  shadow-md transition-all">
